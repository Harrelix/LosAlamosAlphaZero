...
(function () {
  ...
  var START_FEN = 'rnqknr/pppppp/6/6/PPPPPP/RNQKNR'
  ...
  function validSquare (square) {
    return isString(square) && square.search(/^[a-f][1-6]$/) !== -1
  }
  ...
  function constructor (containerElOrString, config) {
    ...
    // fudge factor, and then keep reducing until we find an exact mod 6 for
    // our square size
    function calculateSquareSize () {
      ...
      while (boardWidth % 6 !== 0 && boardWidth > 0) {
    ...
    widget.resize = function () {
      ...
      // set board width
      $board.css('width', squareSize * 6 + 'px')
